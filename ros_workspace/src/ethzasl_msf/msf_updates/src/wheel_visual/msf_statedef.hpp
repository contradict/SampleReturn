...
enum StateDefinition {  //must not manually set the enum values!
  ...
  q_d,                // yaw from world frame to odometry frame in odometry frame
...
typedef boost::fusion::vector<
    ...
    msf_core::StateVar_T<Eigen::Quaternion<double>, q_d,  ///< Rotation from the world frame to the frame in which the wheel odometry is measured expressed in the world frame.
